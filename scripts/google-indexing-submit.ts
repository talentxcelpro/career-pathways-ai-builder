...
export async function runGoogleIndexingPipeline() {
  ...
  const relativePaths = [
    ...
    // 4. Active Job Postings & Role x City Matrices
    ...
    '/jobs/software-engineer/bangalore',
    '/jobs/software-engineer/delhi',
    '/jobs/software-engineer/hyderabad',
    '/jobs/software-engineer/pune',
    '/jobs/software-engineer/mumbai',
    '/jobs/software-engineer/chennai',
    '/jobs/data-analyst/bangalore',
    '/jobs/data-analyst/delhi',
    '/jobs/data-analyst/hyderabad',
    '/jobs/data-analyst/pune',
    '/jobs/data-analyst/mumbai',
    '/jobs/data-scientist/bangalore',
    '/jobs/data-scientist/delhi',
    '/jobs/data-scientist/hyderabad',
    '/jobs/recruiter/bangalore',
    '/jobs/recruiter/delhi',
    '/jobs/recruiter/mumbai',
    '/jobs/recruiter/pune',
    '/jobs/product-manager/bangalore',
    '/jobs/product-manager/delhi',
    '/jobs/product-manager/hyderabad',
    '/jobs/marketing-executive/delhi',
    '/jobs/marketing-executive/mumbai',
    '/jobs/sales-executive/delhi',
    '/jobs/sales-executive/bangalore',
    '/jobs/remote/software-engineer/india',
    '/jobs/remote/data-analyst/india',
    '/jobs/remote/react-developer/india',

    // 5. Major Location Hubs & Tools
    '/locations/bangalore',
    '/locations/delhi',
    '/locations/hyderabad',
    '/locations/pune',
    ...
    '/locations/gurgaon',
    '/locations/remote',
    '/tools/salary-analyzer',

    // 6. Priority Accredited Universities & College Hubs
    '/colleges/delhi/btech',
    '/colleges/karnataka/engineering',
    '/colleges/maharashtra/mba',
    '/colleges/tamil-nadu/btech',
    '/colleges/telangana/engineering',
    ...
    '/colleges/national-institute-of-technology-karnataka',
    '/colleges/vellore-institute-of-technology',

    // 7. Public Network Posts
