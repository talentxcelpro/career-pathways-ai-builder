...
const GENERIC_AI_TIMEOUT_MS = 120000; // 120s — allow first-call model warm-up

const CORPUS_PATH = path.join(__dirname, 'udx-benchmark-corpus.json');
const RESULTS_PATH = path.join(__dirname, 'udx-benchmark-results.json');
