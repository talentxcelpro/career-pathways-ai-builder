...
export const OFFICIAL_GLOBAL_JOB_CATALOG: GlobalJobSeed[] = [
  // ==================== UNITED STATES (USAJOBS) ====================
  {
    ...
    applicationUrl: 'https://www.usajobs.gov',
    isGovernment: true,
  ...
  // ==================== SINGAPORE (CAREERS@GOV) ====================
  {
    ...
    applicationUrl: 'https://www.careers.gov.sg',
    isGovernment: true,
    governmentLevel: 'FEDERAL',
    workplaceType: 'HYBRID',
  },
  ...
  // ==================== AUSTRALIA (APSJOBS) ====================
  {
    ...
    applicationUrl: 'https://www.apsjobs.gov.au',
    isGovernment: true,
    governmentLevel: 'FEDERAL',
    workplaceType: 'ON_SITE',
  },
  ...
  // ==================== CANADA (GC JOBS) ====================
  {
    ...
    applicationUrl: 'https://emploisfp-psjobs.cfp-psc.gc.ca',
    isGovernment: true,
    governmentLevel: 'FEDERAL',
    workplaceType: 'HYBRID',
  },
