...
export const toolsRoutes = [
  ...
  // All remaining tools are admin-only
  ...Array.from({length: 20}, (_, i) => i + 175).map(lineNum => {
    const tools = [
      { title: "Salary Analyzer", to: "/tools/salary-analyzer", icon: <Calculator className="h-4 w-4" />, page: <SalaryAnalyzer /> },
      { title: "Interview Prep", to: "/tools/interview-prep", icon: <MessageSquare className="h-4 w-4" />, page: <InterviewPrep /> },
      { title: "Career Pathfinder", to: "/tools/career-pathfinder", icon: <Target className="h-4 w-4" />, page: <CareerPathfinder /> },
      { title: "Resume Optimizer", to: "/tools/resume-optimizer", icon: <FileText className="h-4 w-4" />, page: <ResumeOptimizer /> },
      { title: "Network Builder", to: "/tools/network-builder", icon: <Users className="h-4 w-4" />, page: <NetworkBuilder /> },
      { title: "Skill Assessor", to: "/tools/skill-assessor", icon: <BookOpen className="h-4 w-4" />, page: <SkillAssessor /> },
      { title: "Job Matcher", to: "/tools/job-matcher", icon: <Briefcase className="h-4 w-4" />, page: <JobMatcher /> },
      { title: "Profile Scorer", to: "/tools/profile-scorer", icon: <User className="h-4 w-4" />, page: <ProfileScore /> },
      { title: "Market Insights", to: "/tools/market-insights", icon: <TrendingUp className="h-4 w-4" />, page: <MarketInsights /> },
      { title: "AI Learning Path Generator", to: "/tools/ai-learning-path-generator", icon: <BookOpen className="h-4 w-4" />, page: <AILearningPathGenerator /> },
      { title: "Cover Letter Generator", to: "/tools/cover-letter-generator", icon: <FileText className="h-4 w-4" />, page: <CoverLetterGenerator /> },
      { title: "Skill Assessment Engine", to: "/tools/skill-assessment-engine", icon: <BookOpen className="h-4 w-4" />, page: <SkillAssessmentEngine /> },
      { title: "Professional Bio Writer", to: "/tools/professional-bio-writer", icon: <Edit3 className="h-4 w-4" />, page: <ProfessionalBioWriter /> },
      { title: "AI Profile Optimizer", to: "/tools/ai-profile-optimizer", icon: <User className="h-4 w-4" />, page: <ProfileOptimizer /> },
      { title: "Mentor Connect Tool", to: "/tools/mentor-connect-tool", icon: <Users className="h-4 w-4" />, page: <MentorConnectTool /> },
      { title: "Resume Gap Analyzer", to: "/tools/resume-gap-analyzer", icon: <Target className="h-4 w-4" />, page: <ResumeGapAnalyzer /> },
      { title: "AI Resume Builder", to: "/tools/ai-resume-builder", icon: <FileText className="h-4 w-4" />, page: <AIResumeBuilder /> },
      { title: "Resume Tailor Tool", to: "/tools/resume-tailor-tool", icon: <Scissors className="h-4 w-4" />, page: <ResumeTailorTool /> },
      { title: "Skill Gap Analyzer", to: "/tools/skill-gap-analyzer", icon: <Target className="h-4 w-4" />, page: <ErrorBoundary><SkillGapAnalyzer /></ErrorBoundary> },
      { title: "Network Growth Tracker", to: "/tools/network-growth-tracker", icon: <Network className="h-4 w-4" />, page: <NetworkGrowthTracker /> },
      { title: "AI Outreach Generator", to: "/tools/ai-outreach-generator", icon: <Send className="h-4 w-4" />, page: <AIOutreachGenerator /> },
      { title: "Resume Analysis", to: "/resume-analysis", icon: <FileText className="h-4 w-4" />, page: <ResumeAnalysis /> },
      { title: "Interview Prep", to: "/interview-prep", icon: <MessageSquare className="h-4 w-4" />, page: <InterviewPrep /> }
    ];
    return tools.map(tool => ({ ...tool, isPublic: false, requiresAdminAccess: true }));
  }).flat().slice(0, 23),
];
