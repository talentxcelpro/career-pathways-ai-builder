...
const FREE_COURSES_MAP: Record<string, { title: string; provider: string; url: string }[]> = {
  ...
  'financial analyst': [
    { title: 'Introduction to Corporate Finance', provider: 'Coursera / Yale (Audit Free)', url: 'https://www.coursera.org/learn/wharton-finance' },
