  ...
  public: {
    Tables: {
      ...
      seo_job_pages: {
        ...
        Relationships: [
          {
            foreignKeyName: "seo_job_pages_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "jobs"
            referencedColumns: ["id"]
      ...
      skill_certifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "skill_certifications_skill_id_fkey"
            columns: ["skill_id"]
            isOneToOne: false
            referencedRelation: "skills_marketplace"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      video_processing_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "video_processing_status_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "posts"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      update_group_last_read: {
        Args: { group_chat_uuid: string }
        Returns: undefined
      }
