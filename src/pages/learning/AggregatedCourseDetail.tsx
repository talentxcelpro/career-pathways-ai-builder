        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <Badge className="bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 text-xs font-extrabold px-3 py-1 rounded-full">
                {course.free_type.replace(/_/g, ' ')}
              </Badge>

              <Badge variant="outline" className="border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-full text-xs font-bold px-3 py-1">
                {course.level} Level
              </Badge>
            </div>

            {/* Course Title - 100% Readable Charcoal Black */}
            <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-tight">
              {course.title}
            </h1>

            {/* Subtitle Description - 100% Readable Slate Gray */}
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 font-medium max-w-2xl leading-relaxed">
              {course.short_description}
            </p>

            {/* Key Metadata Pills */}
            <div className="flex flex-wrap items-center gap-5 text-xs text-slate-700 dark:text-slate-300 font-bold pt-2">
              ...
              {course.talentxcel_match && (
                <div className="flex items-center gap-1.5 text-purple-700 bg-purple-50 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-800 px-3.5 py-1.5 rounded-full font-extrabold">
            ...
            <CardContent className="p-6 space-y-5">
              <div className="space-y-1">
                ...
                <div className="text-xl font-extrabold text-emerald-600 flex items-center justify-between">
                  ...
                  <span className="text-xs font-bold text-slate-400 bg-slate-100 dark:bg-muted px-2 py-0.5 rounded-full">Verified</span>
                </div>
              </div>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-muted/40 border border-slate-200 dark:border-border text-[11px] text-slate-600 dark:text-slate-300 space-y-1">
              ...
              <div className="flex items-center justify-between gap-2 pt-1">
                <Button 
                  ...
                  className="flex-1 rounded-xl text-xs font-extrabold border-slate-300 dark:border-border text-slate-700 dark:text-slate-200 cursor-pointer"
                >
                ...
                <Button 
                  ...
                  className="rounded-xl text-xs font-extrabold border-slate-300 dark:border-border text-slate-700 dark:text-slate-200 cursor-pointer"
                >
