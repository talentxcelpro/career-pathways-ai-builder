...
const GamificationCenter: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-blue-50/30 to-purple-50/30 p-4 native-app-style ios-scroll">
      <div className="container mx-auto max-w-4xl safe-area-top">
        {/* Compact Header */}
