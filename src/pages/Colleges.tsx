...
export default function Colleges() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 pb-20 text-slate-900 dark:text-slate-100">
      <SEOHead title="Colleges & Career Education | TalentXcel" description="Discover universities, higher education institutions, and career learning pathways with TalentXcel." canonical="https://talentxcel.in/colleges" type="website" />
      {/* ───────────────────────────────────────────────────────────────────────── */}
