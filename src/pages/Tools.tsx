    ...
    <div className="min-h-screen bg-[#FBFBFD] dark:bg-[#000000] text-slate-900 dark:text-slate-100 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-10 max-w-7xl">
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-10 pr-4 h-11 rounded-xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 text-xs font-medium text-slate-900 dark:text-white placeholder:text-slate-400 shadow-xs focus-visible:ring-2 focus-visible:ring-indigo-500/30 transition-all"
              />
              {searchQuery && (
                <button 
                  onClick={() => setSearchQuery('')}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-semibold text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 bg-slate-100 dark:bg-slate-800 rounded-full w-4 h-4 flex items-center justify-center"
                >
                  ✕
                </button>
              )}
            ...
            <div className="hidden sm:flex items-center gap-2 px-3.5 h-11 rounded-xl bg-white/90 dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-xl text-xs font-semibold text-slate-600 dark:text-slate-300 shadow-xs">
          ...
          <div className="flex items-center gap-1 overflow-x-auto pb-1 scrollbar-none p-1 rounded-xl bg-slate-200/50 dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-800/60 backdrop-blur-md">
            <button
              onClick={() => setSelectedCategory('all')}
              className={cn(
                "whitespace-nowrap px-3 py-1.5 rounded-lg text-xs font-bold transition-all duration-200 flex items-center gap-1.5",
