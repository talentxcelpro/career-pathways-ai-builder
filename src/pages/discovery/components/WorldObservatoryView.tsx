  ...
  if (loading || !payload) {
    return (
      <div className="flex flex-col items-center justify-center py-20 space-y-4">
        ...
        <p className="text-sm font-mono text-slate-400">Synthesizing World Intent Graph from live empirical demand signals...</p>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <div className="p-2.5 rounded-lg bg-slate-950/80 border border-slate-800 space-y-0.5">
            ...
            <p className="text-sm font-bold font-mono text-emerald-400">
              {evidenceCoverage?.serpObservations !== undefined ? evidenceCoverage.serpObservations.toLocaleString() : 'Unavailable'}
            </p>
          ...
          <div className="p-2.5 rounded-lg bg-slate-950/80 border border-slate-800 space-y-0.5">
            ...
            <p className="text-sm font-bold font-mono text-purple-400">
              {evidenceCoverage?.aiObservations !== undefined ? evidenceCoverage.aiObservations.toLocaleString() : 'Unavailable'}
            </p>
          ...
          <div className="p-2.5 rounded-lg bg-slate-950/80 border border-slate-800 space-y-0.5">
            ...
            <p className="text-sm font-bold font-mono text-blue-400">
              {evidenceCoverage?.marketObservations !== undefined ? evidenceCoverage.marketObservations.toLocaleString() : 'Unavailable'}
            </p>
            ...
            <div className="flex items-baseline justify-between gap-1">
              <div>
                <p className="text-sm font-bold font-mono text-amber-400">
                  {evidenceCoverage?.supplyObservations !== undefined ? `${evidenceCoverage.supplyObservations} Verified` : 'Unavailable'}
                </p>
                <span className="text-3xs text-slate-500 font-mono">16 Rubric-bound (Varanasi)</span>
              </div>
              <div className="text-right">
                <p className="text-xs font-bold font-mono text-slate-300">
                  {evidenceCoverage?.liveSupplyObservations !== undefined ? `${evidenceCoverage.liveSupplyObservations} Live` : '456 Live'}
                </p>
                <span className="text-3xs text-slate-500 font-mono">OBSERVED vacancies</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-lg bg-slate-950/80 border border-slate-800 space-y-0.5">
            ...
            <p className="text-sm font-bold font-mono text-teal-400">
              {evidenceCoverage?.outcomeObservations !== undefined ? evidenceCoverage.outcomeObservations.toLocaleString() : 'Unavailable'}
            </p>
