...
const AICareerNavigator: React.FC = () => {
  ...
  const generateCareerInsights = async () => {
    ...
    try {
      ...
      toast({
        title: "Intelligence Metrics Generated",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg text-gray-600 mt-2">
            Your personal TalentXcel Navigator for career growth and opportunities
          </p>
        </div>
        <Button 
      ...
      <Tabs defaultValue="insights" className="space-y-6">
        ...
        <TabsContent value="roadmap" className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              Performance career roadmap feature coming soon! This will provide step-by-step guidance 
