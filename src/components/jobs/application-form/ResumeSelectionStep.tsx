          ...
          <div className="space-y-3">
            {resumes.length > 0 ? (
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-blue-800 font-medium">
                      Resume Required - Select one below
                    </p>
                  </div>
                </div>
                <RadioGroup
              ...
              <div className="text-center py-8 border-2 border-dashed border-red-200 rounded-lg bg-red-50">
                ...
                <h3 className="font-semibold text-red-800 mb-2">⚠️ Resume Required</h3>
                <p className="text-red-700 text-sm mb-4">
                  You must have a resume to apply for this position. Please upload one below.
                </p>
                <button 
                  onClick={() => onInputChange('resumeSource', 'upload')}
                  className="text-red-600 font-medium hover:text-red-800 underline"
                >
                  Upload Resume Now
                </button>
              </div>
          ...
          <div className="space-y-3">
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-blue-600" />
                <p className="text-sm text-blue-800 font-medium">
                  Resume Required - Upload required
                </p>
              </div>
            </div>
              ...
              <label htmlFor="resume-upload" className="cursor-pointer">
                ...
                <p className="text-sm text-gray-600 font-medium">
                  {formData.uploadedResume ? (
                    ...
                    <>
                      <span className="text-red-600">* Required:</span> Upload Resume (PDF, DOCX, max 5MB)
                    </>
                  )}
                </p>
              </label>
