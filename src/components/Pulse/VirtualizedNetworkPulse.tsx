...
import { NetworkPost } from '@/hooks/useInfiniteNetworkPulse';
import { Skeleton } from '@/components/ui/skeleton';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { Button } from '@/components/ui/button';
import { RefreshCw } from 'lucide-react';

interface VirtualizedNetworkPulseProps {
  posts: NetworkPost[];
  isLoading: boolean;
  isError: boolean;
  error: any;
...
export const VirtualizedNetworkPulse = memo<VirtualizedNetworkPulseProps>(({
  posts,
  isLoading,
  isError,
  error,
...
VirtualizedNetworkPulse.displayName = 'VirtualizedNetworkPulse';
