...
interface LinkedInMobilePulseProps {
  posts: LinkedInPost[];
  loading?: boolean;
...
export const LinkedInMobilePulse: React.FC<LinkedInMobilePulseProps> = ({ 
  posts, 
  loading = false,
  onLike, 
  onBookmark, 
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center p-6">
        <div className="text-center bg-white rounded-3xl p-8 shadow-2xl max-w-sm border border-gray-100 backdrop-blur-xl">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-4">Sign in to view Pulse</h2>
