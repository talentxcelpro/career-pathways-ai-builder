...
import { InfiniteNewsPulse } from "./InfiniteNewsPulse";
import { PersonalizedCommandCenter } from "@/components/CareerAnalytics/PersonalizedCommandCenter";
import { ContentCareerAnalyticsCommandCenter } from "@/components/CareerAnalytics/ContentCareerAnalyticsCommandCenter";
import { useMobileDetection } from "@/hooks/useMobileDetection";
import { MobileNewsPulse } from "@/components/mobile/TouchOptimizedComponents";
...
interface EnhancedNewsPulseProps {
  variant?: 'full' | 'compact';
  maxItems?: number;
  showHero?: boolean;
}

export const EnhancedNewsPulse: React.FC<EnhancedNewsPulseProps> = ({
  variant = 'full',
  maxItems = 20,
  showHero = true
}) => {
  const { isMobile } = useMobileDetection();
  const [viewMode, setViewMode] = useState<'standard' | 'infinite' | 'CareerAnalytics' | 'insights'>('infinite');
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant={viewMode === 'CareerAnalytics' ? 'default' : 'outline'}
                size="sm"
                onClick={() => setViewMode('CareerAnalytics')}
              >
          ...
          {viewMode === 'infinite' && (
            <MobileNewsPulse articles={filteredArticles} />
          )}
          
          {viewMode === 'CareerAnalytics' && (
            <div className="p-4">
  ...
  return (
    <AccessibilityProvider>
      <div className="space-y-6" role="main" aria-label="News and insights content">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => setViewMode('CareerAnalytics')}
                  aria-label="Personal CareerAnalytics view"
                >
                ...
                <Button
                  ...
                  aria-label="Content CareerAnalytics view"
                >
        ...
        {viewMode === 'CareerAnalytics' && <PersonalizedCommandCenter />}
        
        {viewMode === 'insights' && <ContentCareerAnalyticsCommandCenter />}
