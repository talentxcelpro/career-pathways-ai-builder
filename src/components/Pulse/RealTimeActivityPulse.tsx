...
interface RealTimeActivityPulseProps {
  className?: string;
  maxItems?: number;
...
export const RealTimeActivityPulse: React.FC<RealTimeActivityPulseProps> = memo(({
  className,
  maxItems = 50,
...
RealTimeActivityPulse.displayName = 'RealTimeActivityPulse';
