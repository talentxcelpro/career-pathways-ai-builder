...
import { useInfiniteNetworkPulse } from './useInfiniteNetworkPulse';
...
interface EnhancedNetworkPostsPulseProps {
  PulseType: 'all' | 'connections' | 'trending';
  searchTerm?: string;
}

export const EnhancedNetworkPostsPulse: React.FC<EnhancedNetworkPostsPulseProps> = ({
  PulseType,
  searchTerm
}) => {
  ...
  const {
    ...
    fetchNextPage,
    refetch
  } = useInfiniteNetworkPulse({ 
    type: PulseType === 'connections' ? 'connections' : PulseType,
        ...
        {isFetchingNextPage ? (
          ...
          <div className="text-center py-4">
            <div className="inline-flex items-center gap-2 text-muted-foreground">
              ...
              <span className="text-sm">You've reached the end of your Pulse</span>
              <div className="h-px bg-border flex-1 w-20" />
            </div>
          </div>
        ) : null}
