...
export const RSSPulseGenerator = () => {
  const generateRSSPulse = async () => {
    try {
...
${jobs.map(job => `    <item>
      ...
      console.error('Error generating RSS Pulse:', error);
    }
  };
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Generate RSS Pulses for job postings and content syndication
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="text-center">
            <h4 className="font-medium mb-2">Jobs RSS Pulse</h4>
            <p className="text-sm text-gray-600 mb-3">Latest job postings for syndication</p>
            <Button onClick={generateRSSPulse} className="w-full">
          ...
          <div className="text-center">
            <h4 className="font-medium mb-2">Companies RSS Pulse</h4>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <p className="text-sm text-blue-700">
            RSS Pulses can be integrated into job boards, content aggregators, and social media platforms 
