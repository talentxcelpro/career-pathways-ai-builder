...
interface SmartPostNavigatorProps {
  userProfile?: any;
  onPostGenerated?: (content: string) => void;
}

const SmartPostNavigator: React.FC<SmartPostNavigatorProps> = ({ 
  userProfile, 
  onPostGenerated 
}) => {
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-blue-800">
            ...
            Smart Post Navigator
          </CardTitle>
          <CardDescription className="text-blue-600">
            Get Performance post suggestions tailored to your professional network
          </CardDescription>
        </CardHeader>
...
export default SmartPostNavigator;
