...
import { MessageCircle, Copy, RefreshCw, Loader2, Sparkles, Send, Lightbulb } from 'lucide-react';
  ...
  return (
    <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground bg-white/50 p-2 rounded flex items-start gap-2">
          <Lightbulb className="h-3.5 w-3.5 mt-0.5 shrink-0" />
          <p>AI-generated comments can help you engage meaningfully with your network and build stronger professional relationships.</p>
        </div>
      </CardContent>
    </Card>
  );
