...
const FloatingMessenger: React.FC = () => {
  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className="fixed bottom-4 right-4 z-50 h-12 w-12 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
      >
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 transition-all duration-300 ease-in-out">
      <Card className={`w-80 bg-white/95 backdrop-blur-sm border-0 shadow-xl transition-all duration-300 ease-in-out ${
          ...
          <div className="flex flex-col h-[352px]">
            {!selectedConversationId ? (
              ...
              <div className="flex-1 p-2">
                <div className="space-y-1 h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-400">
                  {conversations?.map((conv) => {
                    ...
                    return (
                      <div
                        ...
                        className="p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-sm border border-transparent hover:border-gray-200"
                      >
                        <div className="flex items-center space-x-2">
                  ...
                  {(!conversations || conversations.length === 0) && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-xs text-gray-400 mt-1">Start chatting!</p>
                    </div>
                  )}
                </div>
              </div>
