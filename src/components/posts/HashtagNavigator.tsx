...
interface HashtagNavigatorProps {
  content: string;
  userRole?: string;
  userSkills?: string[];
...
export const HashtagNavigator: React.FC<HashtagNavigatorProps> = ({
  content,
  userRole,
  userSkills = [],
  onHashtagsSelect,
  ...
  const { data: suggestions, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const roleBasedTags = {
        ...
        'Data Scientist': ['#datascience', '#CareerAnalytics', '#machinelearning', '#ai', '#bigdata'],
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        ...
        {suggestions && suggestions.length > 0 && (
          <div>
            <h4 className="text-xs font-medium text-muted-foreground mb-2">Smart Moves</h4>
