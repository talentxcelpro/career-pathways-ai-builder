...
export const TemplateSelector = ({ templates, currentTemplateId, onTemplateSelect }: TemplateSelectorProps) => {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="aspect-[3/4] bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border overflow-hidden">
                <div className="p-2 text-xs" style={{ 
                  fontFamily: template.css_config?.fontFamily || 'Inter',
                  color: template.css_config?.primaryColor || '#2563eb'
                }}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={`text-xs ${getAtsScoreColor(template.ats_score || 85)}`}>
                    <Star className="h-3 w-3 mr-1" />
                    {template.ats_score || 85}% ATS
                  </Badge>
                </div>
