...
**Run ID:** `v4-challenge-1789571461223-992aee73`
**Run Timestamp:** 2026-09-16T15:11:01.222Z
...
|---|---|---|---|
| **SYSTEM_RESOLUTION_LATENCY** | UDX Production Pipeline | **9.0 ms** | Deterministic 9-stage pipeline |
| **MODEL_LATENCY** | Ollama (qwen2.5:7b-instruct-q8_0) | **62.6 s** (62621 ms) | Local Q8_0 CPU inference |
...
|---|---|---|---|
| **1. Time to First Useful Action** | ~35–45 min | 62.6 s | **9 ms** |
...
|---|---|---|---|---|---|---|---|
| 1 | OBJ-001 | CAREER | frontend developer job varanas… | `/jobs?role=frontend-developer&lo…` | 9ms | 62621ms | **UDX_WIN** |
