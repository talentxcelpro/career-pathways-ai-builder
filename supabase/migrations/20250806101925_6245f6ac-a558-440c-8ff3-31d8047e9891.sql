-- Update the profile_completion_reminder template with the custom HTML
...
WHERE template_type = 'profile_completion_reminder';

-- If no rows were updated, insert a new record
INSERT INTO public.email_templates (template_type, subject, content, html_template)
SELECT 'profile_completion_reminder', 
...
WHERE NOT EXISTS (
    SELECT 1 FROM public.email_templates WHERE template_type = 'profile_completion_reminder'
);