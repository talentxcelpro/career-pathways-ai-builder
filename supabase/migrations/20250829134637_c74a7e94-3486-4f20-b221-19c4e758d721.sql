...
-- Update RLS policy for job applications view
DROP POLICY IF EXISTS "Users can view job applications with candidate details" ON public.job_applications_with_candidate_details;

-- Enable RLS on the view (this creates a security layer)
-- Note: Views inherit RLS from underlying tables, but we'll create a function for safer access
