...
-- Now let's add sample lessons for the first module of each course (using 'content' instead of 'description')
INSERT INTO course_lessons (module_id, title, content, lesson_type, duration_minutes, lesson_order, video_url, is_free) 
SELECT 
  m.id,
  CASE 
