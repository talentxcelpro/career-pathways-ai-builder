-- SEO activation with clean JSON formatting
...
INSERT INTO public.platform_metrics (metric_name, metric_category, metric_value, time_period, metadata)
VALUES
  ('seo_pages_generated', 'seo', 5, 'daily', '{"type":"landing_pages","activation":"manual"}'::jsonb),
  ('seo_monitoring_active', 'seo', 1, 'daily', '{"status":"activated","pages_tracked":5}'::jsonb),
  ('seo_cache_entries', 'seo', 3, 'daily', '{"type":"content_cache","activation":"manual"}'::jsonb);