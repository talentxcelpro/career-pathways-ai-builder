...
((SELECT id FROM industries WHERE name = 'Education'), 'Educational Technology', 'Integrate technology in educational settings', ARRAY['Learning Management Systems', 'Educational Apps', 'Online Course Creation', 'Student Analytics', 'Digital Pedagogy'], 'Beginner', 8, ARRAY[], ARRAY['Use educational technology', 'Create digital learning content', 'Analyze student performance'], 45000, 70000, false, true),
