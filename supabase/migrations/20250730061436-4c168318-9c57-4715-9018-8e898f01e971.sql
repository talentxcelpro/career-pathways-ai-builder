-- Insert sample job scraping sources if they don't exist
INSERT INTO public.job_scraping_sources (source_name, source_url, scraping_config, search_keywords, is_active) 
SELECT * FROM (VALUES
...
) AS new_sources(source_name, source_url, scraping_config, search_keywords, is_active)
WHERE NOT EXISTS (
