-- Insert sample companies (using correct column names)
INSERT INTO public.companies (id, name, slug, description, industry, company_size, location, is_verified) VALUES
  ('company-1', 'TechCorp India', 'techcorp-india', 'Leading technology solutions provider', 'Technology', '500-1000', 'Bangalore, India', true),
  ('company-2', 'DataMinds', 'dataminds', 'Data science and analytics company', 'Analytics', '50-200', 'Hyderabad, India', false),
  ('company-3', 'StartupXYZ', 'startupxyz', 'Innovative fintech startup', 'Fintech', '10-50', 'Mumbai, India', true)
