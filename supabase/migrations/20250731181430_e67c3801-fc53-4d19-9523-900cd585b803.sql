-- Update the sync function to work with RLS policies
...
BEGIN
    ...
    LOOP
        BEGIN
            -- Insert each wall post into the posts table using the bot's user context
            PERFORM auth.set_user_id(wall_post.created_by);
