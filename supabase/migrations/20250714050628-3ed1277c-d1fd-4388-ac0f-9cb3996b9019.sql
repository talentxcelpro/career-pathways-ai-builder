-- Phase 4: Advanced Features & Analytics Database Updates
...
CREATE TABLE IF NOT EXISTS public.resume_analytics (
  ...
  event_type TEXT NOT NULL, -- 'view', 'download', 'export', 'share', 'apply', 'interview'
  event_data JSONB DEFAULT '{}',
  source TEXT, -- 'direct', 'search', 'social', 'email'
  location TEXT,
  user_agent TEXT,
