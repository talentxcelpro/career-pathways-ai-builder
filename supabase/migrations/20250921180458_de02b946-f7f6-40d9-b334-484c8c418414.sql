-- Learning + Job Placement Pipeline Database Structure (Updated)
...
CREATE INDEX IF NOT EXISTS idx_placement_pipeline_user_id ON public.placement_pipeline(user_id);
CREATE INDEX IF NOT EXISTS idx_placement_pipeline_stage ON public.placement_pipeline(pipeline_stage);
CREATE INDEX IF NOT EXISTS idx_enhanced_ai_placement_matches_user_id ON public.enhanced_ai_placement_matches(user_id);
CREATE INDEX IF NOT EXISTS idx_enhanced_ai_placement_matches_score ON public.enhanced_ai_placement_matches(match_score DESC);
