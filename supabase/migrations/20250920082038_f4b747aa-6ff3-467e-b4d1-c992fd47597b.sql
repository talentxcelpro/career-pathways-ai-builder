...
-- Fixed version using 'earn' transaction type
...
BEGIN
  ...
  LOOP
    ...
    posts_count := LEAST(posts_count, 50); -- Reduced limit
    connections_count := LEAST(connections_count, 100); -- Reduced limit
    ...
    IF total_txc > 0 THEN
      ...
      INSERT INTO txc_transactions (
        ...
        profile_record.id,
        'earn', -- Using valid transaction type
        total_txc,
