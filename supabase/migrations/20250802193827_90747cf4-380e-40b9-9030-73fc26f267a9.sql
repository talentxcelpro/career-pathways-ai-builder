-- Create enhanced bot management tables for automated content generation
...
CREATE POLICY "System can manage bot content analytics" ON bot_content_analytics FOR INSERT TO authenticated USING (true);
...
CREATE POLICY "System can manage content queue" ON bot_content_queue FOR INSERT TO authenticated USING (true);
