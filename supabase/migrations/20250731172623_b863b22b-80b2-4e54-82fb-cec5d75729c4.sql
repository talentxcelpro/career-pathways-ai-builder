...
CROSS JOIN (
  ...
  ('Career Growth Quick Wins', 'post', 'Career Development', 
   ...
   '["career growth", "professional development", "career tips"]'::text[],
   150, 200, 'engaging'),
  ...
  ('Interview Success Tips', 'post', 'Interview Preparation',
   ...
   '["interview tips", "job interview", "career advice"]'::text[],
   150, 200, 'helpful'),
  ...
  ('Networking Made Simple', 'post', 'Professional Networking',
   ...
   '["professional networking", "career networking", "relationship building"]'::text[],
   150, 200, 'encouraging'),
  ...
  ('Complete Resume Guide', 'article', 'Resume Writing',
   ...
   '["resume writing", "job application", "ATS optimization"]'::text[],
  ...
  ('Remote Work Productivity', 'article', 'Workplace Skills',
   ...
   '["remote work", "productivity tips", "work from home"]'::text[],
   500, 700, 'practical'),
  ...
  ('Leadership Development Path', 'article', 'Leadership',
   ...
   '["leadership development", "management skills", "career progression"]'::text[],
  ...
  ('Career Change Guide', 'seo_page', 'Career Transition',
   ...
   '["career change", "career transition", "professional development"]'::text[],
  ...
  ('Salary Negotiation Mastery', 'seo_page', 'Compensation',
   ...
   '["salary negotiation", "compensation", "pay raise"]'::text[],
   500, 700, 'strategic'),
  ...
  ('Weekly Career Insights', 'newsletter', 'Career Updates',
   ...
   '["career newsletter", "job market trends", "professional development"]'::text[],
  ...
  ('Monthly Success Stories', 'newsletter', 'Community',
   ...
   '["career success", "professional community", "job search"]'::text[],
