-- Phase 2: Critical Database Security Fixes - RLS Policies for Tables Missing Policies (Fixed)
...
-- Fix 5: Add RLS policies for news_articles table (fixed to use correct columns)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
