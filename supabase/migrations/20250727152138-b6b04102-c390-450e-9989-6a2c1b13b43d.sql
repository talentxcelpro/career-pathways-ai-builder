-- Fix posts table to ensure author_id is not nullable and has proper constraints
...
-- Fix connections table to ensure user IDs are not nullable
ALTER TABLE public.connections 
ALTER COLUMN requester_id SET NOT NULL,
ALTER COLUMN recipient_id SET NOT NULL;

-- Add foreign key constraints for connections
ALTER TABLE public.connections 
