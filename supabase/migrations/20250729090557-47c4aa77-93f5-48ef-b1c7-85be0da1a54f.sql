...
-- Create the specific AI bot users using the trigger system
...
-- Ananya
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'ananya@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Ananya", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Sana  
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'sana@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Sana", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Shelly
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'shelly@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Shelly", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Arjun - Application Support Specialist
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'arjun@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Arjun", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Ishaan - Career Coach (Pro)
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'ishaan@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Ishaan", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Meera - Mentorship Coordinator  
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'meera@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Meera", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Nikki - Learning Path Assistant
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'nikki@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Nikki", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Raj - Job Matching AI
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'raj@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Raj", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now()),

-- Zoya - Upskilling Advisor
(gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'zoya@talentxcel.in', crypt('defaultpass123', gen_salt('bf')), now(), now(), now(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Zoya", "is_ai_bot": true, "avatar_url": "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face"}', false, 'authenticated', 'authenticated', now());
