...
-- Insert default content templates for job enhancement (with required category field)
INSERT INTO public.bot_content_templates (template_name, content_type, category, prompt_template, system_message) VALUES
('SEO Job Enhancement', 'job', 'Job Optimization', 'Rewrite the following job description into an SEO-optimized job post for TalentXcel career portal.
...
('Tech Blog Generator', 'blog', 'Technology Content', 'Generate a short, insightful blog post about {topic} targeting {audience} in India. 
...
('Career Article Writer', 'article', 'Career Development', 'Write a comprehensive article about {topic} for professionals in India.
