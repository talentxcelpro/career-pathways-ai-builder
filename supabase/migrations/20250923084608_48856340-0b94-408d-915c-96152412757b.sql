-- Insert sample course data with actual videos
INSERT INTO public.courses (id, title, description, category, level, duration_hours, instructor_name, thumbnail_url, is_published)
VALUES (
