...
// Realistic job levels with salary mapping (Indian market - realistic ranges)
const JOB_LEVEL_MAPPING = {
  ...
  'senior-manager': { level: 'Senior Manager (12-18 years)', salary_range: '₹75-90 LPA' },
  'director': { level: 'Director (15-20 years)', salary_range: '₹90 LPA - 1.2 Cr' },
  'vp': { level: 'Vice President (18+ years)', salary_range: '₹1.2-1.8 Cr' },
  'svp': { level: 'Senior VP (20+ years)', salary_range: '₹1.5-2.5 Cr' },
  'cxo': { level: 'C-Level Executive (20+ years)', salary_range: '₹2-5 Cr' },
  'executive': { level: 'Executive (15+ years)', salary_range: '₹60-90 LPA' }
};
