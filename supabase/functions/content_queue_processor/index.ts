...
console.log('🚀 content_queue_processor v1.0: OpenAI-only with stub fallback');
...
serve(async (req) => {
  ...
  if (req.method === 'GET') {
    return new Response(JSON.stringify({ ok: true, function: 'content_queue_processor', version: '1.0', mode: 'openai-only' }), {
